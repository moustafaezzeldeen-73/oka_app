 ...
 * (jobs.js) turns it into a real Shopify order, COD, on each due date,
...
/**
 * Delivery frequencies. Every one gets the same discount (config/policy.js — 5% by
 ...
 * every cycle (jobs.js), so a price change or a sale reaches subscribers
