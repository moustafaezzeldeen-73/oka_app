 ...
 * (GET /storefront-config). This bundled copy mirrors server/config/policy.js and is
...
export const DEFAULT_CONFIG = {
  currency: 'EGP',
  // The store's fee table (mirrors server/config/zones.js): `under` below the tier
